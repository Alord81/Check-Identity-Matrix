...
bool CheckIsInEqualLine(short arr1[3][3])
{
    return ((arr1[0][0] == 1) && (arr1[1][1] == 1) && (arr1[2][2] == 1));
}

bool IsIdentitylMatrix(short arr1[3][3],short Rows, short Cols)
{
...
void PossibilityOccurrence(short arr1[3][3], short rows,short cols)
{
    ...
    while (true)
    {
        ...
        if (IsIdentitylMatrix(arr1,rows,cols))
        {
            cout << "\ntry number : " << counter << "\n\n";
            cout << "Matrix1:\n";
